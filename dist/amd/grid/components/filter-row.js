System.register(['aurelia-dependency-injection', '../pluginability', '../dataSource/dataSource', '../gridInternals', '../gridOptions', '../models/column', 'marvelous-aurelia-core/aureliaUtils'], function(exports_1, context_1) {
    "use strict";
    ...
    var aurelia_dependency_injection_1, pluginability_1, dataSource_1, gridInternals_1, gridOptions_1, column_1, aureliaUtils_1;
    var FilterRowComponent;
    return {
        setters:[
        ...
        execute: function() {
            FilterRowComponent = (function (_super) {
                ...
                FilterRowComponent = __decorate([
                    aurelia_dependency_injection_1.inject(dataSource_1.DataSource, aureliaUtils_1.AureliaUtils, gridInternals_1.GridInternals, gridOptions_1.GridOptions, column_1.Column)
                ], FilterRowComponent);
                return FilterRowComponent;
            }(pluginability_1.GridComponent));
            exports_1("FilterRowComponent", FilterRowComponent);
        }
    }
});
