...
define(["require", "exports", 'aurelia-dependency-injection', 'marvelous-aurelia-core/utils', '../../pluginability', '../../grid-options', '../../grid-internals', '../../data-source/data-source', '../../constants'], function (require, exports, aurelia_dependency_injection_1, utils_1, pluginability_1, grid_options_1, grid_internals_1, data_source_1, constants_1) {
    "use strict";
    var SortingComponent = (function (_super) {
        ...
        SortingComponent = __decorate([
            aurelia_dependency_injection_1.inject(grid_options_1.GridOptions, grid_internals_1.GridInternals, data_source_1.DataSource)
        ], SortingComponent);
    ...
    exports.SortingBucket = SortingBucket;
});
