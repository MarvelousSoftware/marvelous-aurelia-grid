...
define(["require", "exports", 'aurelia-dependency-injection', 'marvelous-aurelia-core/utils', '../../pluginability', '../../grid', '../../grid-options', '../../grid-internals'], function (require, exports, aurelia_dependency_injection_1, utils_1, pluginability_1, grid_1, grid_options_1, grid_internals_1) {
    "use strict";
    // TODO: persist order information in the state
    var ColumnReorderingComponent = (function (_super) {
    ...
    exports.ColumnReorderingComponent = ColumnReorderingComponent;
});
